...
class MixMessage:
    ...
    def decode(self, ignoreDigestErrors=False):
        ...
        if not ignoreDigestErrors and sanitycheck != self.Digest_Decoded:
        ...
        for i in range(20):
            h = None
            if i == 0:
                h = ParsedMixHeader(self.Packet_Decoded[(512 * i) : (512 * (i+1))], ignoreDigestErrors)
